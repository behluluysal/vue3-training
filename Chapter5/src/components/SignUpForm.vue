<template>
  <form @submit.prevent="handleSubmit">
    ...
    <div>
      ...
      <div>
        <input type="checkbox" value="Behlul" v-model="names" /><label
          >Behlul</label
        >
      </div>
      <div>
        <input type="checkbox" value="Behlul2" v-model="names" /><label
          >Behlul2</label
        >
      </div>
      <div>
        <input type="checkbox" value="Behlul3" v-model="names" /><label
          >Behlul3</label
        >
      </div>
    </div>
